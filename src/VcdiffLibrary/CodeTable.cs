...
namespace VcdiffLibrary
{
    ...
    /// written by Jon Skeet and Marc Gravell.
    /// </para>
    /// <para>
    /// See Section 5.4 and 5.6 of the RFC for documentation about how this table is used.
    /// </para>
    /// </remarks>
    internal sealed class CodeTable
    {
        ...
        /// 1536 bytes.
        /// </summary>
        public const int TableSize = 1536;

        /// <summary>
        /// Default code table specified in RFC 3284.
        /// </summary>
        public static readonly CodeTable Default = BuildDefaultCodeTable();

        /// <summary>
        /// Array of entries in the code table.
        /// </summary>
        /// <remarks>
        /// Instruction code table, containing 256 entries.
        ...
        internal CodeTable(IList<byte> bytes)
        {
            for (var i = 0; i < 256; i++)
            {
        ...
        /// <summary>
        /// Builds the default code table specified in RFC 3284 in section 5.6.
        /// </summary>
        /// <returns>
        ...
        {
            var ret = new byte[TableSize];

            for (var i = 0; i < 256; i++)
            {
                ret[i] = (byte)entries[i, 0].Inst;
                ret[i + 256] = (byte)entries[i, 1].Inst;
